...
public class VueGenerale extends JFrame implements ActionListener{
	...
	private PanelMateriels unPanelMateriel = new PanelMateriels();
	private PanelInterventions unPanelIntervention= new PanelInterventions();

	public VueGenerale(User unUser) {
		this.setTitle("ROILLE SA");
		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		this.getContentPane().setBackground(new Color(255, 145, 77));
		this.setLayout(null);
		...
		this.panelMenu.setBackground(new Color(29, 4, 152));
		...
		this.panelMenu.add(this.btMateriels);
	...
	public void afficherPanel (int choix ) {
		...
		case 4 : unPanelMateriel.setVisible(true);break;
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()== this.btQuitter) {
			PPE.rendreVisibleGenerale(false, null);
			PPE.rendreVisibleConnexion(true);
		}

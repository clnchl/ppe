...
public class vueConnexion extends JFrame implements ActionListener, KeyListener
{
	...
	public vueConnexion() {
		...
		//placemen du logo 
		ImageIcon uneImage = new ImageIcon ("src/images/aramata.png");
		...
		this.panelConnexion.setBackground(new Color(255, 145, 77));
	...
	public void traitement () {
		...
		if (unUser != null) {
			...
			PPE.rendreVisibleGenerale(true, unUser);
			PPE.rendreVisibleConnexion(false);
